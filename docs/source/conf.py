...
try: 
    ...
    version = astatsa.__version__
    # The full version, including alpha/beta/rc tags.
    release = astatsa.__version__
except:
    print('---- Warning: could not get version info; is "astatsa" installed?')
    version = 'unknown'
    release = 'unknown'
...
latex_documents = [
  ('index', 'astatsa.tex', u'astatsa Documentation',
...
man_pages = [
    ('index', 'astatsa', u'astatsa Documentation',
     [u'Andrea Censi'], 1)
]
